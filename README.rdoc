...
1) urxvt - included in mooOs

2) konsole - included in mooOs

3) firefox-aurora - https://aur.archlinux.org/packages/firefox-aurora/

4) maxthon - https://aur.archlinux.org/packages/maxthon-browser/

5) sublime text editor v3 - included in mooOs

- optional package requirements - 64 bit links -

1) pa-applet - https://aur.archlinux.org/packages/pa-applet-git/

2) caffeine - https://aur.archlinux.org/packages/caffeine-bzr/

3) plank - https://www.archlinux.org/packages/community/x86_64/plank/

- tags are what other WM call “Desktops”.

- A “client” is the term for basically an application window.

- Mod4, Super and Windows are the key between Alt and Ctrl.
...
Window manager control
    ...
    Mod4 + Return - Spawn urxvt terminal emulator.
    Mod4 + Shift + Return - Spawn konsole terminal emulator.
    Mod4 + w - Open main menu.
    Mod4 + q - Spawn firefox browser.
    Mod4 + i - Spawn maxthon browser.
    Mod4 + s - Spawn sublime text editor.
    Mod4 + d - Spawn dolphin filemanager.
    Alt + W - Weather
    Mouse Button #9 - Close Window
