...
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/darkwood/icons"

theme.wallpaper                     = os.getenv("HOME") .. "/.config/awesome/themes/darkwood/wall2.jpg"

theme.topbar_path                   = "png:" .. theme.icon_dir .. "/topbar/"

theme.font                          = "Ubuntu 12"
theme.taglist_font                  = "Ubuntu 10"
theme.fg_normal                     = "#F5F5DC"
theme.fg_focus                      = "#F5F5DC"
theme.bg_normal                     = "png:" .. theme.icon_dir .. "/top_bg_normal.png"
theme.fg_urgent                     = "#CC9393"
theme.bg_urgent                     = "#FF9900"
theme.border_width                  = "2"
theme.border_normal                 = "#4B3728"
theme.border_focus                  = "#F5F5DC"
theme.taglist_fg_focus              = "#F5F5DC"
theme.taglist_bg_focus              = "png:" .. theme.icon_dir .. "/taglist_bg_focus.png"
theme.tasklist_bg_normal            = "png:" .. theme.icon_dir .. "/bg_normal.png"
theme.tasklist_fg_normal            = "#FF9900"
theme.tasklist_fg_focus             = "#F5F5DC"
...
theme.menu_fg_normal                = "#F5F5DC"
theme.menu_fg_focus                 = "#FF9900"
--theme.menu_bg_normal                = "#000000"
--theme.menu_bg_focus                 = "#000000"
theme.mem_color                                 = "#F5F5DC"
theme.cpu_color                                 = "#F5F5DC"
theme.fs_color                                  = "#F5F5DC"
theme.temp_color                                = "#F5F5DC"
theme.netup_color                               = "#F5F5DC"
theme.netdown_color                             = "#F5F5DC"
theme.time_color                                = "#F5F5DC"
theme.date_color                                = "#F5F5DC"
theme.vol_color                                 = "#F5F5DC"


theme.awesome_icon                  = theme.icon_dir .. "/start.png"
...
theme.png_spr                       = theme.icon_dir .. " "
theme.png_botm_spr                  = theme.icon_dir .. " "
